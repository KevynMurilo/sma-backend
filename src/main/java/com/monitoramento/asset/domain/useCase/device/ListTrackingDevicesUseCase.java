...
public class ListTrackingDevicesUseCase {
    ...
    public ApiResponseDTO<PagedResponseDTO<TrackingDeviceResponseDTO>> execute(Pageable pageable) {
        Page<TrackingDeviceResponseDTO> dtoPage = trackingDeviceRepository.findAll(pageable)
        ...
        return ApiResponseDTO.success(200, "Dispositivos encontrados", pagedResponse);
    }
}