...
public class EndTripUseCase {
    ...
    public ApiResponseDTO<TripResponseDTO> execute(UUID tripId, UserDetailsImpl userDetails) {
        ...
        if (trip.getStatus() != TripStatus.IN_PROGRESS) {
            return ApiResponseDTO.error(409, "Esta viagem não pode ser finalizada (Status atual: " + trip.getStatus() + ").");
        }
        ...
        return ApiResponseDTO.success(200, "Viagem finalizada", tripMapper.toResponseDTO(savedTrip));
    }
}